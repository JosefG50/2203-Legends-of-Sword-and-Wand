...
public class HeroState {
    ...
    public int getWarriorLvl() {
        return warriorLvl;
    }
    public void setWarriorLvl(int warriorLvl) {
        this.warriorLvl = warriorLvl;
    }
    public int getOrderLvl() {
        return orderLvl;
    }
    public void setOrderLvl(int orderLvl) {
        this.orderLvl = orderLvl;
    }
    public int getChaosLvl() {
        return chaosLvl;
    }
    public void setChaosLvl(int chaosLvl) {
        this.chaosLvl = chaosLvl;
    }
